...
class TypeUserApiIT extends IntegrationTestBase {
    ...
    void listEmpty() throws Exception {
        mockMvc.perform(get(ApiPaths.USERS_TYPE))
    ...
    void listWithData() throws Exception {
        userTypeJpaRepository.save(UserTypeEntity.builder()
                .id(UUID.randomUUID())
                .userType("admin")
                .build());
        userTypeJpaRepository.save(UserTypeEntity.builder()
    ...
    void getByIdSuccess() throws Exception {
        ...
        mockMvc.perform(get(ApiPaths.USERS_TYPE + "/" + id))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.nameType").value("admin"));
    }

    @Test
    @DisplayName("GET /api/v1/users-type/{id} retorna 404 quando não encontrado")
    void getByIdNotFound() throws Exception {
        mockMvc.perform(get(ApiPaths.USERS_TYPE + "/" + UUID.randomUUID()))
    ...
    void createSuccess() throws Exception {
        mockMvc.perform(post(ApiPaths.USERS_TYPE)
    ...
    void updateSuccess() throws Exception {
        ...
        mockMvc.perform(put(ApiPaths.USERS_TYPE + "/" + id)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    @DisplayName("PUT /api/v1/users-type/{id} retorna 404 quando não encontrado")
    void updateNotFound() throws Exception {
        mockMvc.perform(put(ApiPaths.USERS_TYPE + "/" + UUID.randomUUID())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(VALID_BODY))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteSuccess() throws Exception {
        ...
        mockMvc.perform(delete(ApiPaths.USERS_TYPE + "/" + id))
    ...
    @Test
    @DisplayName("DELETE /api/v1/users-type/{id} retorna 404 quando não encontrado")
    void deleteNotFound() throws Exception {
        mockMvc.perform(delete(ApiPaths.USERS_TYPE + "/" + UUID.randomUUID()))
                .andExpect(status().isNotFound());
    }
